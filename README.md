...
## API 명세
| API 이름    | 메서드 | 엔드포인트  | 요청 바디 예시                                  | 응답 코드 | 응답 바디 예시                                  |
|-------------|--------|-------------|------------------------------------------------|-----------|------------------------------------------------|
| 회원가입    | POST   | /register   | {"username": "사용자이름", "email": "이메일", "password": "비밀번호"} | 200       | {"message": "회원가입이 성공적으로 완료되었습니다."} |
| 로그인      | POST   | /login      | {"email": "이메일", "password": "비밀번호"}      | 200       | {"message": "로그인이 성공적으로 완료되었습니다."}   |
| 게시글 조회 | GET    | /posts      | -                                              | 200       | {"posts": [{"id": 1, "title": "제목", "content": "내용", "author": "작성자", "created_at": "작성시간"}, {...}]} |
