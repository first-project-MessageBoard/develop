...
## 📋 API 명세
| 분류     | 기능            | 메서드 | 엔드포인트            | 예시 바디                                         | 예시 응답 바디                                    |
|----------|-----------------|--------|-----------------------|---------------------------------------------------|----------------------------------------------------|
| 회원관리 | 회원가입        | POST   | /register             | {"username": "사용자이름", "email": "이메일", "password": "비밀번호"} | {"message": "회원가입이 성공적으로 완료되었습니다."} |
|          | 로그인          | POST   | /login.html           | {"email": "이메일", "password": "비밀번호"}           | {"message": "로그인이 성공적으로 완료되었습니다."}   |
