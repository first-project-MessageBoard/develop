...
## 📋 API 명세
| 분류     | 기능            | 메서드 | 엔드포인트            | 예시 바디                                         | 응답 코드 | 예시 응답 바디                                    |
|----------|-----------------|--------|-----------------------|---------------------------------------------------|------------|----------------------------------------------------|
| 회원관리 | 회원가입        | POST   | /register             | {"username": "사용자이름", "email": "이메일", "password": "비밀번호"} | 200        | {"message": "회원가입이 성공적으로 완료되었습니다."} |
|          | 로그인          | POST   | /login.html           | {"email": "이메일", "password": "비밀번호"}           | 200        | {"message": "로그인이 성공적으로 완료되었습니다."}   |
| 게시글   | 게시글 작성     | POST   | /writing.html         | -                                                 | -          | -                                                  |
|          | 게시글 수정     | GET POST | /edit<int:id>       | -                                                 | -          | -                                                  |
|          | 게시글 삭제     | POST   | /delete/<int:id>      | -                                                 | -          | -                                                  |
| 댓글     | 댓글 작성       | POST   | -                     | -                                                 | -          | -                                                  |
|          | 댓글 수정       | GET POST | -                   | -                                                 | -          | -                                                  |
|          | 댓글 삭제       | GET POST | -                   | -                                                 | -          | -                                                  |
| 검색     | 게시글 조회     | GET    | /search               | -                                                 | -          | -                                                  |
| 정렬     | 최신순 정렬     | GET    | -                     | -                                                 | -          | -                                                  |
|          | 오래된 순 정렬 | GET    | /oldest               | -                                                 | -          | -                                                  |
|          | 댓글 많은 순 정렬 | GET | /most_comments       | -                                                 | -          | -                                                  |
|          | 댓글 적은 순 정렬 | GET | /least_comments      | -                                                 | -          | -                                                  |
